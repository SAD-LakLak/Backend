...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'rest_framework.authentication.SessionAuthentication',  # Add this for social auth integration
    )
}
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'core.pipeline.get_avatar',  # We'll create this custom pipeline function
)
...
# Token settings for REST integration
SOCIAL_AUTH_ALLOWED_REDIRECT_HOSTS = ['localhost:3000', 'laklakbox.ir']
